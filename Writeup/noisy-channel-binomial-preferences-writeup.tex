...
2016a}). In the case of binomials, there is evidence that humans develop
...
emerging over \emph{butter and bread}.\footnote{There's an argument to
  ...
  (\citeproc{ref-odonnellProductivityReuseLanguage2016}{2016})'s models
  ...
  \citeproc{ref-morganFormalizingTheoriesStorage}{Morgan, n.d.}).} While
...
(\citeproc{ref-tabossi1980linguisticcontextpriming}{1980}){]}. If this
...
\bibitem[\citeproctext]{ref-morganFormalizingTheoriesStorage}
