...
counterbalanced_data = counterbalanced_data %>%
  ...
  mutate(list = ((condition + Item - 2) %% 6) + 1)
...
full_data = full_data %>%
  mutate(`Sentence Type` = case_when(
    ...
    !is.na(`Sentence Type`) ~ `Prime Type`))

col_names = c("Item", "Binomial", "WordA", "WordB", "Questions", "Answer", "SentenceType", "TargetSentence", "PrimeType", "Prime", "FilenamePrime", "Condition", "List")
...
write_csv(list1, '../Data/list1.csv')
write_csv(list2, '../Data/list2.csv')
write_csv(list3, '../Data/list3.csv')
write_csv(list4, '../Data/list4.csv')
write_csv(list5, '../Data/list5.csv')
write_csv(list6, '../Data/list6.csv')
```
