...
write_csv(list1, '../Data/list1')
write_csv(list2, '../Data/list2')
write_csv(list3, '../Data/list3')
write_csv(list4, '../Data/list4')
write_csv(list5, '../Data/list5')
write_csv(list6, '../Data/list6')
```
