...
b0 = -22.55398 #Intercept
b1 = -21.50768 #prime
b2 = -16.75813 #target
b3 = -12.16123 #interaction

#standard deviations from pilot data
#these are our subject-level effects 
sd_b0j = 46.40  #Intercept
sd_b1j = 55.9   #Prime Frequency
sd_b2j = 30.43  #Target Frequency
sd_b3j = 64.33  #Interaction (Prime*Target)

#correlations from pilot brms model
cor_b0j_b1j = 0.01    #Intercept,Prime Frequency
cor_b0j_b2j = -0.13   #Intercept,Target Frequency
cor_b0j_b3j = -0.13   #Intercept,prime:target
cor_b1j_b2j = 0.03    #Prime Frequency,Target Frequency
cor_b1j_b3j = -0.39   #Prime Frequency,Interaction
cor_b2j_b3j = -0.1    #Target Frequency,Interaction
...
#Item level effects
#standard deviations from pilot data
sd_b0k = 83.10  #Intercept
sd_b1k = 45.22  #Prime Frequency
sd_b2k = 63.44  #Target Frequency
sd_b3k = 48.98  #Interaction (Prime*Target)

#correlations for items
cor_b0k_b1k = -0.45   # Intercept,Prime 
cor_b0k_b2k = -0.53   # Intercept,Target 
cor_b0k_b3k = -0.23   # Intercept,Interaction
cor_b1k_b2k =  0.15   # Prime,Target
cor_b1k_b3k = -0.03   # Prime,Prime:target
cor_b2k_b3k = -0.04   # Target,prime:target
...
sim_d = function(seed, n) {
  ...
  #these are our subject-level effects 
  sd_b0j = 46  #Intercept
  sd_b1j = 20   #Prime Frequency
  sd_b2j = 30.43  #Target Frequency
  sd_b3j = 30  #Interaction (Prime*Target)
  
  #correlations from pilot brms model
  cor_b0j_b1j = 0.08   #Intercept,Prime Frequency
  cor_b0j_b2j = -0.17   #Intercept,Target Frequency
  cor_b0j_b3j = -0.15   #Intercept,prime:target
  cor_b1j_b2j = -0.02    #Prime Frequency,Target Frequency
  cor_b1j_b3j = -0.01   #Prime Frequency,Interaction
  cor_b2j_b3j = 0.04    #Target Frequency,Interaction
  ...
  #Item level effects
  #standard deviations from pilot data
  sd_b0k = 19.81  #Intercept
  sd_b1k = 18.90  #Prime Frequency
  sd_b2k = 29.58  #Target Frequency
  sd_b3k = 28.01  #Interaction (Prime*Target)
  
  #correlations for items
  cor_b0k_b1k = -0.01   # Intercept,Prime 
  cor_b0k_b2k = -0.04   # Intercept,Target 
  cor_b0k_b3k = 0.01   # Intercept,Interaction
  cor_b1k_b2k =  -0.01   # Prime,Target
  cor_b1k_b3k = -0.01  # Prime,Prime:target
  cor_b2k_b3k = 0.04   # Target,prime:target
...
t1 = Sys.time()
fit = 
  brm(data = d, cores = 4, chains = 4, iter = 4000, warmup = 2000,
...
n_sim = 2 #set to 2 initially for debugging

t1 = Sys.time()

s = #n = 100: power of 0.33
  tibble(seed = 1:n_sim) %>% 
  mutate(d = map(seed, sim_d, n = 50)) %>% #what about 100 participants?
